...
| R8-09 | Deploy de rules common p/ projetos Claude-Code-alvo | ⬜ carry-forward |

**Cobertura: 8/8 requisitos de escopo (R8-09 conscientemente deferido).**
...
| 2 | IMPORTANTE | trade-off herdado | **carry-forward R8-09** — rule não chega a projetos Claude-Code-alvo (mesmo defeito de `delta-spec` v7). |
