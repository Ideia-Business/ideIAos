...
description: v14 "IdeiaOS Cockpit" — console web CTO local-first. v14.0 (Substrato+Espinha) EXECUTADO/COMPLETO 2026-06-21. v14.1 (MVP Bridge) PLANEJADO 2026-06-21 (8 planos/4 waves, verificado 3 lentes, mergeado em main). Próximo = /gsd-execute-phase 14.1. GOTCHA: CLI GSD não resolve fases v14 (sem v14-ROADMAP.md) → planejar espelhando o método v14.0.
metadata:
  node_type: memory
  type: project
...
Cross-link:
[[project-milestone-v13-security-freshness]], [[project-aiox-core-pristine-overlay]], [[learning-autosync-pause-file-guard-not-deployed]], [[learning-active-milestone-gate-couples-via-shared-file]].
