...
description: v14 "IdeiaOS Cockpit" — console web CTO local-first. v14.0 (Substrato+Espinha) EXECUTADO/COMPLETO 2026-06-21. v14.1 (MVP Bridge) EXECUTADO/code-complete + CLOSEOUT 2026-06-22 (bug CORS-preflight S-05 corrigido). v14.4 (write-path security) contrato /spec MERJADO 2026-06-22 (specs/cockpit/spec.md 9→20 reqs) + ADRs Q1-Q3 PROPOSTOS (docs/decisions/v14.4-*; recomenda O2, lista pinada local; CRÍTICO de revogação forjada corrigido; aguardam aceitação + bootstrap; R-WP10 fechado). Tags v14.0/v14.1 DEFERIDAS (1 máq/0d). GOTCHA: CLI GSD não resolve fases v14 (sem v14-ROADMAP.md) → planejar/fechar espelhando o método v14.0.
metadata:
  node_type: memory
  type: project
