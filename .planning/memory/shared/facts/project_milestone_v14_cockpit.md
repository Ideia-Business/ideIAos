...
description: v14 "IdeiaOS Cockpit" — console web CTO local-first. v14.0 (Substrato+Espinha) EXECUTADO/COMPLETO 2026-06-21. v14.1 (MVP Bridge) EXECUTADO/code-complete + CLOSEOUT 2026-06-22 (8 planos, A1–A12 verdes, bug CORS-preflight S-05 achado no visual-loop e corrigido, re-selo PASS). Tag DEFERIDA (1 máq/0d). GOTCHA: CLI GSD não resolve fases v14 (sem v14-ROADMAP.md) → planejar/fechar espelhando o método v14.0.
metadata:
  node_type: memory
  type: project
...
Cross-link:
[[project-milestone-v13-security-freshness]], [[project-aiox-core-pristine-overlay]], [[learning-autosync-pause-file-guard-not-deployed]], [[learning-active-milestone-gate-couples-via-shared-file]], [[learning-curl-masks-cors-preflight-verify-browser]].
