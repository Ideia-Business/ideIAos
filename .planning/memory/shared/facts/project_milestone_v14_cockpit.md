...
description: v14 "IdeiaOS Cockpit" — console web CTO local-first. v14.0 (Substrato+Espinha) EXECUTADO/COMPLETO 2026-06-21. v14.1 (MVP Bridge) EXECUTADO/code-complete + CLOSEOUT 2026-06-22 (bug CORS-preflight S-05 corrigido). v14.4 (write-path security) contrato /spec MERJADO 2026-06-22 (specs/cockpit/spec.md 9→20 reqs) + ADRs Q1-Q3 ACEITOS (docs/decisions/v14.4-*; O2 + lista pinada local) + plano de bootstrap verificado (.planning/.../14.4-write-path/, 5 proof-gates B0-B4 fail-closed; 2 BLOCKERS+2 CRITICALs adversariais integrados). R-WP10 segue FECHADO até bootstrap-por-exit-code; próximo = executar o bootstrap. Cerimônia N=2-real + Q5 abertas. Tags v14.0/v14.1 DEFERIDAS (1 máq/0d). GOTCHA: CLI GSD não resolve fases v14 (sem v14-ROADMAP.md) → planejar/fechar espelhando o método v14.0.
metadata:
  node_type: memory
  type: project
