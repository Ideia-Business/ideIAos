...
# Delta: cockpit — v14-cockpit-foundation

**Capability alvo:** cockpit
**Change slug:** v14-cockpit-foundation
**Data do delta:** 2026-06-20

Tokens canônicos (PT-BR de superfície → interno usado pelo merge):
- ADICIONADO = ADDED · MODIFICADO = MODIFIED · REMOVIDO = REMOVED · RENOMEADO = RENAMED
