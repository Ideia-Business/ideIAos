...
```
=== FORMAT ===
[Name of the chosen carousel format]
...
...continue until all slides are complete...
...
=== CAPTION ===
[Hook paragraph — must open with first 125 characters that compel "more" tap.]

[Body paragraph — expanded argument with key points. Use line breaks for readability.]

[Closing question — provocative, open-ended question that drives comments.]
...
- **Too little text per carousel slide** — Slides with fewer than 40 words are superficial and fail to deliver value. Exception: user explicitly requests short/punchy slides.
- **Too much text per carousel slide** — Exceeding 80 words per slide destroys readability. Use the two-layer hierarchy (headline + supporting text) to keep density manageable.
